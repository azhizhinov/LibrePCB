...
GraphicsExportDialog::GraphicsExportDialog(
  ...
  if (mMode == Mode::Board) {
    QAction* actionNew =
        EditorCommandSet::instance().newItem.createAction(this, this, [this]() {
    ...
    QAction* actionRemove =
        EditorCommandSet::instance().remove.createAction(this, this, [this]() {
    ...
    QAction* actionRename =
        EditorCommandSet::instance().renameItem.createAction(
            this, this, [this]() {

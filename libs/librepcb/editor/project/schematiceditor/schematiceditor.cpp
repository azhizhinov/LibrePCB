...
void SchematicEditor::createActions() noexcept {
  ...
  mActionCopy.reset(cmd.copy.createAction(this, mFsm.data(),
                                          &SchematicEditorFsm::processCopy));
  mActionCut.reset(
      cmd.cut.createAction(this, mFsm.data(), &SchematicEditorFsm::processCut));
  ...
  mActionMirrorHorizontal.reset(cmd.mirrorHorizontal.createAction(
      this, mFsm.data(), &SchematicEditorFsm::processMirror));
  ...
  mActionNewSheet.reset(
      cmd.newSheet.createAction(this, this, &SchematicEditor::addSchematic));
  mActionOrderPcb.reset(cmd.orderPcb.createAction(this, this, [this]() {
    mProjectEditor.execOrderPcbDialog(nullptr, this);
  }));
  mActionPaste.reset(cmd.paste.createAction(this, mFsm.data(),
  ...
  mActionQuit.reset(cmd.quit.createAction(this, this, &SchematicEditor::close));
  ...
  mActionRenameSheet.reset(cmd.renameSheet.createAction(
      this, this, [this]() { renameSchematic(mActiveSchematicIndex); }));
  mActionRotateCcw.reset(cmd.rotateCcw.createAction(
      this, mFsm.data(), &SchematicEditorFsm::processRotateCcw));
  mActionRotateCw.reset(cmd.rotateCw.createAction(
      this, mFsm.data(), &SchematicEditorFsm::processRotateCw));
...
void SchematicEditor::createMenus() noexcept {
  ...
  mb.addAction(mDockPages->toggleViewAction());
